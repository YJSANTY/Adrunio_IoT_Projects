...
void sendMessage() {
    ...
    read_soil();
    read_ldr();
    String msg_1 =   String("e") + String(data.temp)  ;
    String msg_2 =   String("d") +String(data.ldr);
    String msg_3 =   String("o") +String(data.soil);
    String msg_4 =   String("u") +String(data.humi);
